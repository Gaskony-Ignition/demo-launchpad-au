...
//
// It runs at 1600x1100, deliberately: the point is to READ the rendered text,
// and a tall window puts all of it on screen at once. That also means this
// check cannot see a layout that only fails when the window is small - the KPI
// Overview scrolled as a page at anything under 1490px wide and passed here
// every time. Sizing is `tools/check_page_scroll.js`, which runs at the 1366x768
// floor. Run both.
